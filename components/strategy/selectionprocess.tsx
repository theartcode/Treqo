...
const steps = [
  {
    ...
    title: "Get Noticed",
    sub: "FIRST FILTER",
    desc: "Your resume is more than a document. It tells us how early you’ve started building, exploring, creating, and moving toward business, growth, or execution.",
    icon: BookOpen,
    tags: ["Proof of Curiosity", "Initiative", "Direction"],
    accent: "#7C3AED",
  ...
  },
  {
    num: "02",
    title: "Think",
    sub: "FOUNDATION CHECK",
    desc: "Shortlisted students receive a test link with real situations, aptitude, and mindset-based questions designed to identify founder thinking and broad problem-solving ability.",
    icon: Target,
    tags: ["Situational IQ", "Aptitude", "Founder Thinking"],
    accent: "#6D28D9",
  ...
  },
  {
    num: "03",
    title: "Speak",
    sub: "HUMAN VALIDATION",
    desc: "Qualified candidates enter a conversation round where we assess clarity, ambition, coachability, communication, and readiness to thrive in a real execution-driven environment.",
    icon: Rocket,
    tags: ["Ambition", "Coachability", "Clarity"],
    accent: "#5B21B6",
  ...
  },
  {
    ...
    title: "Enter",
    sub: "FINAL SEAT",
    desc: "The selected few receive an official Treqo selection mail and cohort offer letter, securing their seat in the next high-performance batch.",
    icon: Briefcase,
    tags: ["Selection Letter", "Offer Mail", "Cohort Confirmed"],
    accent: "#4C1D95",
