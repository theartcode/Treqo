  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "1300px", margin: "0 auto", padding: "0 5%", position: "relative", zIndex: 10 }}>
        ...
        {/* ── HEADER ── */}
        <div className="d2-header" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", alignItems: "flex-end", gap: "40px", marginBottom: "56px" }}>
          <div>
            <motion.div
        ...
        >
          ...
          >
            <div>
              ...
              <div style={{ fontSize: "22px", fontWeight: 900, color: hov(5) ? "#6D28D9" : "#7C3AED", letterSpacing: "-0.03em", lineHeight: 1, marginBottom: "10px", transition: "color 0.4s" }}>
                0 REAL NUMBERS 
              </div>
      ...
      <style>{`
        ...
        @media (max-width: 1024px) {
          ...
          .d2-card1 { grid-column: 1 / 7 !important; grid-row: 1 !important; }
          .d2-card2 { grid-column: 1 / 4 !important; grid-row: 2 !important; }
          .d2-card3 { grid-column: 4 / 7 !important; grid-row: 2 !important; }
          .d2-card4 { grid-column: 1 / 4 !important; grid-row: 3 !important; }
          .d2-card5 { grid-column: 4 / 7 !important; grid-row: 3 !important; }
        }
        ...
        @media (max-width: 640px) {
          ...
          .d2-header > div:last-child { padding-left: 0 !important; }
          .d2-grid {
            grid-template-columns: 1fr !important;
            grid-template-rows: auto !important;
            gap: 12px !important;
